...
for url in "${urls[@]}"; do
  ...
  httpx -silent -status-code -u "$url" -H "User-Agent: $user_agent" | grep -E '200|201|202|300|301|302|401|403|405|500|501|502|503|504' >> "$live_subs"
done

echo "[+] Alive URLs saved in: $live_subs"
